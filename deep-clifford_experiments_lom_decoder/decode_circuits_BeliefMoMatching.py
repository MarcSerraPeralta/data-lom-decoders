...
MAX_BP_ITERS = 100
OUTPUT_DIR = pathlib.Path(f"output_BeliefMoMatching_max-bp-iters-{MAX_BP_ITERS}")
...
for nr in [1, 2, 3]:
    for distance in [11]:
        ...
        decoder = BeliefMoMatching(
            encoded_circuit, stab_coords, bp_method="min_sum", max_iter=MAX_BP_ITERS
        )
